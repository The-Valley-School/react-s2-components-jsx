...
Hemos aprendido también a bindear el evento de click en React para que ejecute una función.

Creamos un componente botón que reciba una función para ejecutar en el click y el texto a mostrar:
